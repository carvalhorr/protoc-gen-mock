...
var file_greeter_proto_rawDesc = []byte{
	...
	0x12, 0x63, 0x61, 0x72, 0x76, 0x61, 0x6c, 0x68, 0x6f, 0x72, 0x72, 0x2e, 0x67, 0x72, 0x65, 0x65,
	...
	0x52, 0x08, 0x67, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x32, 0x4f, 0x0a, 0x07, 0x47, 0x72,
	0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x44, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x1b,
	0x2e, 0x63, 0x61, 0x72, 0x76, 0x61, 0x6c, 0x68, 0x6f, 0x72, 0x72, 0x2e, 0x67, 0x72, 0x65, 0x65,
	0x74, 0x65, 0x72, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x63, 0x61,
	0x72, 0x76, 0x61, 0x6c, 0x68, 0x6f, 0x72, 0x72, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72,
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x13, 0x5a, 0x11, 0x2e,
	0x3b, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
...
var file_greeter_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: carvalhorr.greeter.Request
	(*Response)(nil), // 1: carvalhorr.greeter.Response
}
var file_greeter_proto_depIdxs = []int32{
	0, // 0: carvalhorr.greeter.Greeter.Hello:input_type -> carvalhorr.greeter.Request
	1, // 1: carvalhorr.greeter.Greeter.Hello:output_type -> carvalhorr.greeter.Response
...
func (c *greeterClient) Hello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/carvalhorr.greeter.Greeter/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "carvalhorr.greeter.Greeter",
